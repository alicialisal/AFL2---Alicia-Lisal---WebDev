               ...
               <section class="s-pagecontent pagecontent">
                    ...
                    <div class="row pageintro">
                        <div class="column xl-6 lg-12">
                            <h2 class="text-display-title">Creative Solutions for Your Projects</h2>
                        </div>
                        <div class="column xl-6 lg-12 u-flexitem-x-right">
                            <p class="lead">
                                Drawing from my experience in UI/UX design, graphic design, and social media management, I craft innovative solutions to bring ideas to life. From designing intuitive interfaces to creating impactful digital content, I deliver tailored services to meet your project needs.
                            </p>
                        </div>
                    </div>  <!-- pageintro -->
                            ...
                            <div class="grid-full grid-list-items list-items show-ctr">
                                ...
                                <div class="grid-list-items__item list-items__item">
                                    <div class="list-items__item-header">
                                        <h3 class="list-items__item-title">UI/UX Design</h3>
                                    </div>
                                    <div class="list-items__item-text">
                                        <p>
                                        Crafting intuitive and visually appealing designs to ensure seamless user experiences. Combining creativity and usability to create applications that resonate with users.
                                        </p>
                                ...
                                <div class="grid-list-items__item list-items__item">
                                    ...
                                    <div class="list-items__item-text">
                                        <p>
                                            Developing creative visuals for branding and digital content. My designs blend aesthetics and functionality to capture attention and deliver impactful messages.
                                        </p>

                                        <ul class="list-services">
                                            <li>Social Media assets</li>
                                            <li>Flyer & Posters Design</li>
                                        </ul>
                                    </div>
                                </div> <!-- end list-items__item -->
                                <div class="grid-list-items__item list-items__item">
                                    <div class="list-items__item-header">
                                        <h3 class="list-items__item-title">Content Creation</h3>
                                    </div>
                                    <div class="list-items__item-text">
                                        <p>
                                            Creating engaging content for digital platforms, including social media campaigns, recaps, and storytelling. Tailoring content to connect with audiences effectively.
                                        </p>

                                        <ul class="list-services">
                                            <li>Video Recap Editing</li>
                                ...
                                <div class="grid-list-items__item list-items__item">
                                    ...
                                    <div class="list-items__item-text">
                                        <p>
                                            Managing projects effectively by coordinating teams, setting goals, and ensuring timely delivery of creative outputs while maintaining quality standards.
                                        </p>
                                ...
                                <div class="grid-list-items__item list-items__item">
                                    <div class="list-items__item-header">
                                        <h3 class="list-items__item-title">Software Development</h3>
                                    </div>
                                    <div class="list-items__item-text">
                                        <p>
                                            Building efficient and scalable applications with a focus on logical thinking and problem-solving. Experienced in developing solutions that meet user needs and optimize performance.
                                        </p>

                                        <ul class="list-services">
                                            <li>Web Development (PHP, Dart)</li>
                                ...
                                <div class="grid-list-items__item list-items__item">
                                    <div class="list-items__item-header">
                                        <h3 class="list-items__item-title">Database Management</h3>
                                    </div>
                                    <div class="list-items__item-text">
                                        <p>
                                            Experienced in designing, managing, and optimizing databases. Proficient in SQL databases, ensuring efficient data storage and retrieval while maintaining integrity and security.
                                        </p>

                                        <ul class="list-services">
                                            <li>Database Design & Architecture</li>
                                            <li>SQL Solutions</li>
                                            <li>Data Integrity & Optimization</li>
                                        </ul>
                                    </div>
                                </div> <!-- end list-items__item -->
