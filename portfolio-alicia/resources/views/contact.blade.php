               ...
               <section class="s-pagecontent pagecontent">
                    ...
                    <div class="row pageintro">
                        ...
                        <div class="column xl-6 lg-12 u-flexitem-x-right">
                            <p class="lead">
                                Whether you're looking to enhance your brand, improve your services, or expand your reach, I’m here to help you achieve your goals. With a blend of creativity, technology, and strategy, together we can create impactful solutions that drive results and elevate your business.
                            </p>
                        </div>                       
                    </div> <!-- pageintro -->   
                    ...
                    <div class="row pagemedia">
                        <d class="column xl-12">
                            <figure class="page-media">                                
                                <img src="{{ asset('images/thumbs/contact/Contact-us.jpg') }}" 
                        ...
                        <div class="column xl-12">
                            ...
                            <div class="row">
                                <div class="column xl-6 md-12 contact-cta">     
                                    <p>
                                        I’m always excited to collaborate on creative projects! If you’re looking for a passionate, tech-savvy partner to help bring your ideas to life, let’s connect. Together, we can create something impactful and meaningful. Reach out today to get started!
                                    </p>
                                ...
                                <div class="column xl-5 md-12 u-flexitem-x-right">
                                    ...
                                    <div class="contact-block">
                                        <h6>Email</h6>
                                        <a href="mailto:ajuanita@student.ciputra.ac.id">ajuanita@student.ciputra.ac.id</a>
                                    </div>

                                    <div class="contact-block">
                                        <h6>Phone</h6>
                                        <ul class="contact-list">
                                            <li><a href="tel:0899-0080-560">+62 899 0080 560</a></li>
                                        </ul>
                                    </div>
