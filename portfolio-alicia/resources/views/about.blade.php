               ...
               <section class="s-pagecontent pagecontent">
                    ...
                    <div class="row pageintro">
                        <div class="column xl-6 lg-12">
                            <h2 class="text-display-title">Passionate, Driven, and Eager to Learn</h2>
                        </div>
                        <div class="column xl-6 lg-12 u-flexitem-x-right">
                            <p class="lead">
                                I am a dynamic and adaptable individual with a strong passion for technology and problem-solving. Whether it's developing web applications, creating innovative solutions, or working with a team, I am always excited to take on new challenges. I believe in continuous learning and collaboration, and I aim to use my skills to make a positive impact on both the tech industry and the communities I serve.
                            </p>
                        </div>                       
                    </div> <!-- end pageintro -->   
                    ...
                    <div class="row pagemedia">
                        <d class="column xl-12">
                            <figure class="page-media">                                
                                <img src="{{ asset('images/intro-bg.png') }}" 
                    ...
                    <div class="row width-narrower pagemain">
                        <div class="column xl-12"> 
                            ...
                            <div class="grid-list-items list-items">
                                <div class="grid-list-items__item list-items__item u-remove-bottom">
                                    <div class="list-items__item-header">
                                        <h6 class="list-items__item-small-title">Continuous Learning</h6>
                                    </div>
                                    <p>
                                        I believe in the power of continuous learning to stay ahead in an ever-evolving world. Whether it's exploring new programming languages or diving deep into the latest technology trends, I'm always excited to expand my knowledge and skills.
                                    </p>
                                </div>
                                <div class="grid-list-items__item list-items__item u-remove-bottom">
                                    <div class="list-items__item-header">
                                        <h6 class="list-items__item-small-title">Collaboration and Teamwork</h6>
                                    </div>
                                    <p> 
                                        Collaboration is at the heart of success. I value teamwork and believe that sharing ideas and working together leads to stronger solutions and innovations. Building connections and learning from others is essential to both personal and professional growth.
                                    </p>
                                </div>
                                <div class="grid-list-items__item list-items__item u-remove-bottom">
                                    <div class="list-items__item-header">
                                        <h6 class="list-items__item-small-title">Problem-Solving</h6>
                                    </div>
                                    <p>
                                        I approach challenges with a problem-solving mindset. Whether it's coding, designing systems, or handling day-to-day tasks, I am dedicated to finding efficient, practical solutions that make a meaningful impact.
                                    </p>
                                </div>
                                <div class="grid-list-items__item list-items__item u-remove-bottom">
                                    <div class="list-items__item-header">
                                        <h6 class="list-items__item-small-title">Integrity and Responsibility</h6>
                                    </div>
                                    <p>
                                        Integrity is fundamental to my work. I believe in delivering on my commitments, being transparent in all my actions, and taking responsibility for both successes and challenges. This mindset helps me build trust and credibility in every project I undertake.
                                    </p>
                                </div>
                            </div> <!--grid-list-items -->
                            ...
                            <p>
                                I am passionate about learning, creating, and collaborating with others. Whether it’s mastering new programming languages, tackling design challenges, or exploring innovative solutions to real-world problems, I believe in constantly improving myself. I approach each task with curiosity, determination, and a willingness to learn from both successes and failures. My goal is to use my skills to not only advance in my career but also to positively impact the people and communities I work with. I am deeply committed to integrity, and I strive to ensure that every project I undertake reflects my dedication to quality, responsibility, and teamwork.
                            </p>
...
@section('content')
    ...
    <section class="s-pagecontent pagecontent">
        <div class="row pageintro">
            ...
            <div class="column xl-6 lg-12 u-flexitem-x-right">
                <p class="lead">
                    I am a dynamic and adaptable individual with a strong passion for technology and problem-solving. Whether it's developing web applications, creating innovative solutions, or working with a team, I am always excited to take on new challenges.
                </p>
            </div>                       
        </div>
