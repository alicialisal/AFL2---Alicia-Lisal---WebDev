            ...
            <div class="row s-header__inner width-sixteen-col">
                ...
                <nav class="s-header__nav">
                    ...
                    <ul class="s-header__menu-links">
                        ...
                        <li class="current"><a href="{{ route('blog') }}">Projects</a></li>
               ...
               <section class="s-pageheader pageheader">
                    <div class="row">
                        <div class="column xl-12">
                            <h1 class="page-title">
                                <span class="page-title__small-type text-pretitle">My Experiences</span>
                                Recent Projects
                            </h1>
                        </div>
                    </div>
                                ...
                                <div class="grid-full grid-list-items">
                                    ...
                                    <div class="grid-list-items__item blog-card">
                                        <div class="blog-card__header">
                                            ...
                                            <h3 class="blog-card__title"><a href="https://www.dreamhost.com/r.cgi?287326">UI/UX Designer for our Application Final Project</a></h3>
                                        </div>
                                        <div class="blog-card__text">
                                            <p>
                                                Check out my project with my teammates, called MomEase, an application designed to address Baby Blues by supporting mothers with mood tracking, parenting resources, and a safe space for sharing experiences.
                                                Explore the project on Figma <a href="https://www.figma.com/design/GWBZVXbzNXox2fwRXKavgV/ALP-Semester-3?node-id=166-2&t=9wjPg9EDvun0PVxH-1">here</a>.
                                            </p>
                                        </div>
                                    </div> <!-- end blog-card -->
                                    <div class="grid-list-items__item blog-card">
                                        <div class="blog-card__header">
                                            <div class="blog-card__cat-links">
                                                <a href="#0">Social Media Team</a>
                                            </div>
                                            <h3 class="blog-card__title"><a href="single.html">Managing @uc_oweekmks Social Media</a></h3>
                                        </div>
                                        <div class="blog-card__text">
                                            <p>
                                                Our team collaborated to manage the social media account, <a href = "https://www.instagram.com/uc_oweekmks/">@uc_oweekmks</a>, by creating engaging content such as interview videos, informative posts about Oweek updates, and event recap highlights. Through these efforts, we ensured that the social media presence effectively reflected the spirit of Oweek.
                                            </p>
                                        </div>
                                    </div> <!-- end blog-card -->
                                    <div class="grid-list-items__item blog-card">
                                        <div class="blog-card__header">
                                            ...
                                            <h3 class="blog-card__title"><a href="single.html">Managing @gkkatanjungbunga Social Media</a></h3>
                                        </div>
                                        <div class="blog-card__text">
                                            <p>
                                                As part of the Social Media Team, we collaboratively managed the <a href = "https://www.instagram.com/gkkatanjungbunga/">@gkkatanjungbunga</a> account by taking turns to create and schedule posts. 
                                                Our responsibilities included designing content for event announcements, sharing uplifting messages, and posting event recaps. 
                                            </p>
                                        </div>
                                    </div> <!-- end blog card -->
